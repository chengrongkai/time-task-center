package com.crk.timetaskcenter.common.job;

import com.crk.timetaskcenter.common.utils.DataResult;
import com.crk.timetaskcenter.common.utils.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
	...
	final TimeTaskLogService timeTaskLogService;

	public ScheduleJob(TimeTaskLogService timeTaskLogService) {
		this.timeTaskLogService = timeTaskLogService;
	}


	@Override
    protected void executeInternal(JobExecutionContext context){
        TimeTaskEntity scheduleJob = (TimeTaskEntity) context.getMergedJobDataMap()
        		.get(TimeTaskEntity.JOB_PARAM_KEY);

        //获取spring bean
        TimeTaskLogService scheduleJobLogService = (TimeTaskLogService) SpringContextUtils.getBean("TimeTaskLogService");
        
        //数据库保存执行记录
        TimeTaskLogEntity log = new TimeTaskLogEntity();
